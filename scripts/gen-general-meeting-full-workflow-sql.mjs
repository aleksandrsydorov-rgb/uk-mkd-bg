...
-- Admin lifecycle: public.has_staff_role('${ADMIN}') via can_manage_building_governance().
-- =============================================================================
...
writeFileSync(join(dir, 'general_meeting_full_workflow_hotfix.sql'), hotfix + grants, { encoding: 'utf8' });
writeFileSync(join(dir, 'general_meeting_full_workflow_verify.sql'), verify, { encoding: 'utf8' });
console.log('wrote general_meeting_full_workflow sql');
