...
writeFileSync(join(dir, 'support_fee_annual_pricing_hotfix.sql'), hotfix, { encoding: 'utf8' });
writeFileSync(join(dir, 'support_fee_annual_pricing_verify.sql'), verify, { encoding: 'utf8' });
console.log('wrote support_fee_annual_pricing sql');
